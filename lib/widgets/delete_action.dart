...
class DeleteAction extends StatelessWidget {
  const DeleteAction({super.key, this.onClickDelete});
            ...
            showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                      ...
                      child: Column(
                        children: [
                          CircleAvatar(
                            ...
                            backgroundColor: Color.fromRGBO(255, 31, 31, 0.1),
                          ),
                          SizedBox(
                            height: 22,
                          ),
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                            ...
                            style: OutlinedButton.styleFrom(
                                side: BorderSide(color: TColors.red, width: 1)),
                          ),
                        ),
                        SizedBox(
                          width: 32,
                  ...
                  actionsPadding:
                      EdgeInsets.only(left: 50, right: 50, bottom: 40),
                );
              },
            );
          },
