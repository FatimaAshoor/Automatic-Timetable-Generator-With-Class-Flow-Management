  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Department Manager Profile Page"),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 10,),
                Text("Edit Department Manager Information",style:TextStyle(
          ...
          Form(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // Name
                  Text("Department Manager Name", style:TextStyle(
                      fontWeight: FontWeight.bold,
                      color: TColors.black),),
                  SizedBox(height: 6,),
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        hintText: "Department Manager Name",
                  ...
                  // Email
                  Text("Department Manager Email", style:TextStyle(
                      fontWeight: FontWeight.bold,
                      color: TColors.black), ),
                  SizedBox(height: 6,),
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        hintText: "Department Manager Email",
                        border: OutlineInputBorder()),
                  ...
                  // Password
                  Text("Department Manager Password", style:TextStyle(
                      fontWeight: FontWeight.bold,
                      color: TColors.black), ),
                  SizedBox(height: 6,),
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        hintText: "Department Manager Password",
                        border: OutlineInputBorder()),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 10,),
                Text("Department Manager Information",style:TextStyle(
                    fontWeight: FontWeight.bold,
                    color: TColors.black, fontSize: 16), )
              ],
            ),
